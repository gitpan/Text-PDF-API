...
Text::PDF::API::Color - A OO-Color Module for PDFs.
...
=head1 SYNOPSIS
	...
	$cl = Text::PDF::API::Color->new;
	$cl = Text::PDF::API::Color->newRGB($r,$g,$b);
	$cl = Text::PDF::API::Color->newHSV($h,$s,$v);
	$cl = Text::PDF::API::Color->newHSL($h,$s,$l);
...
=item Text::PDF::API::Color->newRGB $r, $g, $b
...
=item Text::PDF::API::Color->newHSV $h, $s, $v
...
=item Text::PDF::API::Color->newHSL $h, $s, $l
...
=item Text::PDF::API::Color->newGrey $grey
